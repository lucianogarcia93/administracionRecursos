...
class IngresoController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request)
        {
            ...
            ->join('detalle_ingreso as di','i.idingreso','=','di.ingreso_idingreso')// realiza la union de ingreso llave primaria con la foranea de detalle de ingreso
    ...
    {                                                  //inciamos una transaccion para guardar todo el ingreso y el detalle de ingreso pero a la misma vez por algun problema en la red
        try {
            ...
            while ($cont<count($idarticulo)) {
                ...
                $detalle->articulo_idarticulo=$idarticulo[$cont];
        ...
        {
            //si hay un error borra los registros que se hayan guardado
            DB::rollback();
        }
    ...
    public function exportPdf()
 {
    ...
    public function show($id)
    {
        $ingreso=DB::table('ingreso as i')
            ...
            ->join('detalle_ingreso as di','i.idingreso','=','di.ingreso_idingreso')
