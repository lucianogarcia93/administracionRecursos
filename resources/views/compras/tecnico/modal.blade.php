...
{{form::Open(array('action'=>array('TecnicoController@destroy',$per->idpersona),'method'=>'delete'))}}
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Eliminar Tecnico</h4>

            
            </div>
            <div class="modal-body">
                <p>Confime si desea eliminar Tecnico</p>
